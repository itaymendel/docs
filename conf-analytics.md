...
Bit’s analytics are sent throughout Bit’s execution to analytics.bitsrc.io over HTTPS.

## Who?

Bit’s detailed analytics are accessible only to Bit’s current maintainers. [Contact us](https://bitsrc.io/support) if you are a maintainer and need access.
